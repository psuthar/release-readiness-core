...
**Generated:** 2026-04-30T21:19:35Z  
**Base ref:** `1870dea8e33357cd9733bcb38846587c702b81ad`  
...
- Non-test files: **7** with nearby test in diff: **6** (ratio **86%**)

### Change concentration

- **Mode:** `focused` — Most churn (~62%) sits under `web/src`.
- Top area: `web/src` (~62% of churn); **4** distinct path prefixes.

### Hotspots (recent git activity)

- **`web/src`** — 23 distinct commits (sampled) — Prefix touched in 23 of the last 50 sampled commits — sustained activity; extra regression care.
- **`web/tests`** — 5 distinct commits (sampled) — Prefix touched in 5 of the last 50 sampled commits — sustained activity; extra regression care.

### PR intent vs diff

- **Intent strength:** `strong`
- **Subject line (source):** SCRUM-130: add skeleton loading state for session view
- **Keywords matched:** session
- **Domains implied by text:** auth, api
- **Domains in diff (non-test):** orchestration, scripts, web
...
- **Points:** 4.0
- **Detail:** Prefix touched in 23 of the last 50 sampled commits — sustained activity; extra regression care.
...
**Score:** 20.0/100 (medium) · base `1870dea8e33357cd9733bcb38846587c702b81ad`
...
- Diff overlaps a path prefix touched in multiple recent commits (4 pts): Prefix touched in 23 of the last 50 sampled commits — sustained activity; extra regression care.
