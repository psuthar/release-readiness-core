...
**Base ref:** `551b8fed5b4ad09b5ac64796f7b3d711c3885781`  
...
- Confirm scope with author: PR text implies domains auth but diff may differ.
...
- Top area: `internal/handlers` (~51% of churn); **4** distinct path prefixes.

### Hotspots (recent git activity)

- **`web/src`** — 35 distinct commits (sampled) — Prefix touched in 35 of the last 50 sampled commits — sustained activity; extra regression care.
- **`web/tests`** — 21 distinct commits (sampled) — Prefix touched in 21 of the last 50 sampled commits — sustained activity; extra regression care.
- **`internal/handlers`** — 5 distinct commits (sampled) — Prefix touched in 5 of the last 50 sampled commits — sustained activity; extra regression care.

### PR intent vs diff

- **Intent strength:** `strong`
- **Subject line (source):** SCRUM-217: dual-write invited_role on membership PATCH so the UI sees the new role
- **Keywords matched:** invite
- **Domains implied by text:** auth
...
- **Points:** 4.0
- **Detail:** Prefix touched in 35 of the last 50 sampled commits — sustained activity; extra regression care.
...
- Evidence: 90% of LOC churn is in test files
...
**Score:** 6.0/100 (low) · base `551b8fed5b4ad09b5ac64796f7b3d711c3885781`
...
**Top risk drivers:**
- Diff overlaps a path prefix touched in multiple recent commits (4 pts): Prefix touched in 35 of the last 50 sampled commits — sustained activity; extra regression care.
