...
**Base ref:** `253cc9f3962a4dc1d5143f3b2090ccca823ef6a1`  
...
- **Mode:** `focused` — Most churn (~59%) sits under `web/src`.
- Top area: `web/src` (~59% of churn); **2** distinct path prefixes.
...
- **`web/tests`** — 13 distinct commits (sampled) — Prefix touched in 13 of the last 50 sampled commits — sustained activity; extra regression care.

### PR intent vs diff

- **Intent strength:** `strong`
- **Subject line (source):** SCRUM-186: align creator topbar with participant topbar (role badge + session menu)
...
**Score:** 16.0/100 (low) · base `253cc9f3962a4dc1d5143f3b2090ccca823ef6a1`
