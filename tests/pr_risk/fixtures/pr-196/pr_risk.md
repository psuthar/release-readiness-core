...
**Generated:** 2026-04-30T21:19:16Z  
**Base ref:** `7a3b0b6004de8d184a27fa9003ba7b1a98005f4c`  
...
- **Mode:** `focused` — Most churn (~95%) sits under `web/src`.
- Top area: `web/src` (~95% of churn); **2** distinct path prefixes.
...
- **`web/tests`** — 14 distinct commits (sampled) — Prefix touched in 14 of the last 50 sampled commits — sustained activity; extra regression care.

### PR intent vs diff

- **Intent strength:** `unknown`
- **Subject line (source):** SCRUM-195: restyle Suggested Next Actions panel header
...
- Evidence: 45% of LOC churn is in test files
...
**Score:** 10.0/100 (low) · base `7a3b0b6004de8d184a27fa9003ba7b1a98005f4c`
...
**Score math:** factors 14.0 − reducers 4.0 → 10.0 · low
