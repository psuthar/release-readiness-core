...
**Base ref:** `7ef1f7c23c945fc0e28be5301e3ff0cbc503d11f`  
...
- **`web/src`** — 25 distinct commits (sampled) — Prefix touched in 25 of the last 50 sampled commits — sustained activity; extra regression care.

### PR intent vs diff

- **Intent strength:** `strong`
- **Subject line (source):** SCRUM-146: replace participant decision banner with Decision Brief header
- **Keywords matched:** ci
...
**Score:** 10.0/100 (low) · base `7ef1f7c23c945fc0e28be5301e3ff0cbc503d11f`
