...
**Base ref:** `a27a86910e2dbb00ee6c46ba64ef417127686ad5`  
...
- **Subject line (source):** SCRUM-126: extract duplicated MicIcon to shared icons component
- **Keywords matched:** ci
...
- Evidence: Style-only: moved identical MicIcon SVG from QAPanel.jsx and QAHistory.jsx
...
**Score:** 8.0/100 (low) · base `a27a86910e2dbb00ee6c46ba64ef417127686ad5`
...
- Diff overlaps a path prefix touched in multiple recent commits (4 pts): Prefix touched in 20 of the last 50 sampled commits — sustained activity; extra regression care.
