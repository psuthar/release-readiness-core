...
**Base ref:** `47f0e19408968a6aa3f6e6aaa2791f7dc3eb6bb4`  
...
| Reducers subtotal (points subtracted) | **24.0** |
...
- **`web/src`** — 19 distinct commits (sampled) — Prefix touched in 19 of the last 50 sampled commits — sustained activity; extra regression care.

### PR intent vs diff

- **Intent strength:** `unknown`
- **Subject line (source):** SCRUM-123: smooth voice confirm transition — single textarea inline layout
...
- **Points:** 4.0
- **Detail:** Prefix touched in 19 of the last 50 sampled commits — sustained activity; extra regression care.
...
- Evidence: Style-only: no style changes.

### `test_heavy_diff` (-4.0 points)

- Test-heavy diff
- Primarily affects: `test_confidence`
- Evidence: 43% of LOC churn is in test files
...
**Score:** 0.0/100 (low) · base `47f0e19408968a6aa3f6e6aaa2791f7dc3eb6bb4`
...
**Top risk drivers:**
- Diff overlaps a path prefix touched in multiple recent commits (4 pts): Prefix touched in 19 of the last 50 sampled commits — sustained activity; extra regression care.
...
**Score math:** factors 4.0 − reducers 24.0 → 0.0 · low
