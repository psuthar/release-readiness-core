...
**Base ref:** `fa9516ee46a5be9101f052475a338a19db4bfaf7`  
...
- **Mode:** `focused` — Most churn (~65%) sits under `web/src`.
- Top area: `web/src` (~65% of churn); **2** distinct path prefixes.

### Hotspots (recent git activity)

- **`web/src`** — 24 distinct commits (sampled) — Prefix touched in 24 of the last 50 sampled commits — sustained activity; extra regression care.
...
- **Subject line (source):** SCRUM-131: guard localhost API error message behind isDev flag
...
- **Points:** 4.0
- **Detail:** Prefix touched in 24 of the last 50 sampled commits — sustained activity; extra regression care.
...
**Score:** 4.0/100 (low) · base `fa9516ee46a5be9101f052475a338a19db4bfaf7`
...
**Top risk drivers:**
- Diff overlaps a path prefix touched in multiple recent commits (4 pts): Prefix touched in 24 of the last 50 sampled commits — sustained activity; extra regression care.
