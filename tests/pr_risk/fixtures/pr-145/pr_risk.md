...
**Base ref:** `5f528a388968cbfc016cb324aaec25d13406d59e`  
...
- **`web/src`** — 15 distinct commits (sampled) — Prefix touched in 15 of the last 50 sampled commits — sustained activity; extra regression care.

### PR intent vs diff

- **Intent strength:** `strong`
- **Subject line (source):** SCRUM-120: promote decisions panel to top-level layout in participant view
- **Keywords matched:** ci
...
- **Points:** 4.0
- **Detail:** Prefix touched in 15 of the last 50 sampled commits — sustained activity; extra regression care.
...
**Score:** 10.0/100 (low) · base `5f528a388968cbfc016cb324aaec25d13406d59e`
...
**Top risk drivers:**
- Diff overlaps a path prefix touched in multiple recent commits (4 pts): Prefix touched in 15 of the last 50 sampled commits — sustained activity; extra regression care.
