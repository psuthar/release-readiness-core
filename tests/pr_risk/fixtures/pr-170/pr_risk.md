...
**Generated:** 2026-04-30T21:19:28Z  
**Base ref:** `520200111ce16c7caad161d41b419b5482e04cf8`  
...
- Non-test files: **6** with nearby test in diff: **0** (ratio **0%**)

### Change concentration

- **Mode:** `focused` — Most churn (~79%) sits under `eval/qa`.
- Top area: `eval/qa` (~79% of churn); **4** distinct path prefixes.

### Hotspots (recent git activity)

- **`eval/qa`** — 8 distinct commits (sampled) — Prefix touched in 8 of the last 50 sampled commits — sustained activity; extra regression care.
- **`scripts/test_run_qa_eval.py`** — 6 distinct commits (sampled) — Prefix touched in 6 of the last 50 sampled commits — sustained activity; extra regression care.

### PR intent vs diff

- **Intent strength:** `strong`
- **Subject line (source):** SCRUM-144: add explicit eval contracts for FF-019 through FF-026
- **Keywords matched:** ci
...
- **Points:** 4.0
- **Detail:** Prefix touched in 8 of the last 50 sampled commits — sustained activity; extra regression care.
...
**Score:** 10.0/100 (low) · base `520200111ce16c7caad161d41b419b5482e04cf8`
...
**Top risk drivers:**
- Diff overlaps a path prefix touched in multiple recent commits (4 pts): Prefix touched in 8 of the last 50 sampled commits — sustained activity; extra regression care.
