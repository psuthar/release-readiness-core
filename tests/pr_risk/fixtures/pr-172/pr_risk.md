...
**Base ref:** `2882e87fa15f8338bb89244dec2e0c6c32ff74e0`  
...
- **`web/src`** — 26 distinct commits (sampled) — Prefix touched in 26 of the last 50 sampled commits — sustained activity; extra regression care.

### PR intent vs diff

- **Intent strength:** `unknown`
- **Subject line (source):** SCRUM-147: open materials pane by default and label collapsed rail
...
- Evidence: 53% of LOC churn is in test files
...
**Score:** 0.0/100 (low) · base `2882e87fa15f8338bb89244dec2e0c6c32ff74e0`
...
**Top risk drivers:**
- Diff overlaps a path prefix touched in multiple recent commits (4 pts): Prefix touched in 26 of the last 50 sampled commits — sustained activity; extra regression care.
