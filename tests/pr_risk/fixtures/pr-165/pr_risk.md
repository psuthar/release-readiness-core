...
**Base ref:** `2c8513caf72875d47eaad1f32fba30bcd25905bf`  
...
- Top area: `scripts/run_qa_eval.py` (~54% of churn); **2** distinct path prefixes.
...
- **Subject line (source):** SCRUM-138: Add aggregate correctness/hallucination reporting
- **Keywords matched:** ci
...
**Score:** 6.0/100 (low) · base `2c8513caf72875d47eaad1f32fba30bcd25905bf`
