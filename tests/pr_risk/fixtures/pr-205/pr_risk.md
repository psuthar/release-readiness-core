...
**Generated:** 2026-04-30T21:19:11Z  
**Base ref:** `d298cd15e5c542d527437861bdb2401aea739b8c`  
...
- Non-test files: **6** with nearby test in diff: **6** (ratio **100%**)

### Change concentration

- **Mode:** `focused` — Most churn (~73%) sits under `web/src`.
- Top area: `web/src` (~73% of churn); **2** distinct path prefixes.

### Hotspots (recent git activity)

- **`web/src`** — 31 distinct commits (sampled) — Prefix touched in 31 of the last 50 sampled commits — sustained activity; extra regression care.
- **`web/tests`** — 16 distinct commits (sampled) — Prefix touched in 16 of the last 50 sampled commits — sustained activity; extra regression care.

### PR intent vs diff

- **Intent strength:** `strong`
- **Subject line (source):** SCRUM-204: surface Decision Maker role + vote readiness in creator UI
- **Keywords matched:** ci
...
- **Points:** 4.0
- **Detail:** Prefix touched in 31 of the last 50 sampled commits — sustained activity; extra regression care.
...
- Evidence: 65% of LOC churn is in test files
...
**Score:** 16.0/100 (low) · base `d298cd15e5c542d527437861bdb2401aea739b8c`
...
- Diff overlaps a path prefix touched in multiple recent commits (4 pts): Prefix touched in 31 of the last 50 sampled commits — sustained activity; extra regression care.
