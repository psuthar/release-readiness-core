...
**Generated:** 2026-04-30T21:19:21Z  
**Base ref:** `8dcbeec128ec82f1eedbcb7172b1ef4718360396`  
...
- **Mode:** `focused` — Most churn (~96%) sits under `web/src`.
- Top area: `web/src` (~96% of churn); **2** distinct path prefixes.
...
- **`web/tests`** — 11 distinct commits (sampled) — Prefix touched in 11 of the last 50 sampled commits — sustained activity; extra regression care.

### PR intent vs diff

- **Intent strength:** `unknown`
- **Subject line (source):** SCRUM-163: align rationale textbox and preserve multiline editing
...
**Score:** 0.0/100 (low) · base `8dcbeec128ec82f1eedbcb7172b1ef4718360396`
