...
**Generated:** 2026-04-30T21:19:40Z  
**Base ref:** `021ccb51f06d8f7a109423ce239697bf12a7c0fd`  
...
- **`web/src`** — 16 distinct commits (sampled) — Prefix touched in 16 of the last 50 sampled commits — sustained activity; extra regression care.

### PR intent vs diff

- **Intent strength:** `strong`
- **Subject line (source):** SCRUM-132: fix decisions panel toggle hover turning solid blue
- **Keywords matched:** ci
...
- **Points:** 4.0
- **Detail:** Prefix touched in 16 of the last 50 sampled commits — sustained activity; extra regression care.
...
- Evidence: Style-only: scoped hover background for .decisionsPanelToggle in ParticipantM...
...
**Score:** 8.0/100 (low) · base `021ccb51f06d8f7a109423ce239697bf12a7c0fd`
...
- Diff overlaps a path prefix touched in multiple recent commits (4 pts): Prefix touched in 16 of the last 50 sampled commits — sustained activity; extra regression care.
