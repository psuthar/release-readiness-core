...
**Base ref:** `b7c4661e8f98e705a0047fd504514bae810158ac`  
...
- **`web/src`** — 17 distinct commits (sampled) — Prefix touched in 17 of the last 50 sampled commits — sustained activity; extra regression care.

### PR intent vs diff

- **Intent strength:** `unknown`
- **Subject line (source):** SCRUM-121: show unread badge on collapsed materials panel
...
- **Points:** 4.0
- **Detail:** Prefix touched in 17 of the last 50 sampled commits — sustained activity; extra regression care.
...
- Evidence: 69% of LOC churn is in test files
...
**Score:** 0.0/100 (low) · base `b7c4661e8f98e705a0047fd504514bae810158ac`
...
**Top risk drivers:**
- Diff overlaps a path prefix touched in multiple recent commits (4 pts): Prefix touched in 17 of the last 50 sampled commits — sustained activity; extra regression care.
