...
**Base ref:** `e6b0de324a4d73c27f0827266a4727dde31898be`  
...
- **Mode:** `focused` — Most churn (~79%) sits under `web/tests`.
- Top area: `web/tests` (~79% of churn); **2** distinct path prefixes.

### Hotspots (recent git activity)

- **`web/src`** — 36 distinct commits (sampled) — Prefix touched in 36 of the last 50 sampled commits — sustained activity; extra regression care.
- **`web/tests`** — 23 distinct commits (sampled) — Prefix touched in 23 of the last 50 sampled commits — sustained activity; extra regression care.

### PR intent vs diff

- **Intent strength:** `strong`
- **Subject line (source):** SCRUM-222: show member count and creator on Session Selection cards
...
- **Points:** 4.0
- **Detail:** Prefix touched in 36 of the last 50 sampled commits — sustained activity; extra regression care.
...
- Evidence: 79% of LOC churn is in test files
...
**Score:** 6.0/100 (low) · base `e6b0de324a4d73c27f0827266a4727dde31898be`
...
**Top risk drivers:**
- Diff overlaps a path prefix touched in multiple recent commits (4 pts): Prefix touched in 36 of the last 50 sampled commits — sustained activity; extra regression care.
