...
**Base ref:** `ffb8736883befb750ce7b6c817e4e28073ca396f`  
...
- **`web/src`** — 13 distinct commits (sampled) — Prefix touched in 13 of the last 50 sampled commits — sustained activity; extra regression care.

### PR intent vs diff

- **Intent strength:** `strong`
- **Subject line (source):** SCRUM-118: Remove blur-submit from rationale field; add explicit save action
- **Keywords matched:** ci
...
- **Points:** 4.0
- **Detail:** Prefix touched in 13 of the last 50 sampled commits — sustained activity; extra regression care.
...
**Score:** 16.0/100 (low) · base `ffb8736883befb750ce7b6c817e4e28073ca396f`
...
- Diff overlaps a path prefix touched in multiple recent commits (4 pts): Prefix touched in 13 of the last 50 sampled commits — sustained activity; extra regression care.
