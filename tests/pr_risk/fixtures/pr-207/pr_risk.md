...
**Base ref:** `9cb636352c1bdcac7af702b998dd7e3a966cdbf5`  
...
- Confirm scope with author: PR text implies domains rag, workflows but diff may differ.
...
- **Subject line (source):** SCRUM-206: end-to-end Decision Maker assignment + closeout coverage
- **Keywords matched:** rag, ci
- **Domains implied by text:** rag, workflows
...
**Score:** 4.0/100 (low) · base `9cb636352c1bdcac7af702b998dd7e3a966cdbf5`
...
**Score math:** factors 10.0 − reducers 6.0 → 4.0 · low
