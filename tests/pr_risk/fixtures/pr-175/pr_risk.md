...
**Base ref:** `7e0961fd48ba27563e2156856a1c3efd0a0851f9`  
...
- **Mode:** `focused` — Most churn (~90%) sits under `web/src`.
- Top area: `web/src` (~90% of churn); **2** distinct path prefixes.

### Hotspots (recent git activity)

- **`web/src`** — 29 distinct commits (sampled) — Prefix touched in 29 of the last 50 sampled commits — sustained activity; extra regression care.
- **`web/tests`** — 8 distinct commits (sampled) — Prefix touched in 8 of the last 50 sampled commits — sustained activity; extra regression care.

### PR intent vs diff

- **Intent strength:** `strong`
- **Subject line (source):** SCRUM-150: participant first-join onboarding dialog
- **Keywords matched:** ci
...
- **Points:** 4.0
- **Detail:** Prefix touched in 29 of the last 50 sampled commits — sustained activity; extra regression care.
...
**Score:** 10.0/100 (low) · base `7e0961fd48ba27563e2156856a1c3efd0a0851f9`
...
**Top risk drivers:**
- Diff overlaps a path prefix touched in multiple recent commits (4 pts): Prefix touched in 29 of the last 50 sampled commits — sustained activity; extra regression care.
