...
**Base ref:** `d7e3a10163ca9e01b9279227e8d4390e1b307d90`  
...
- **`web/tests`** — 12 distinct commits (sampled) — Prefix touched in 12 of the last 50 sampled commits — sustained activity; extra regression care.

### PR intent vs diff

- **Intent strength:** `unknown`
- **Subject line (source):** SCRUM-164: keep rationale input inline to the right of stance
...
**Score:** 4.0/100 (low) · base `d7e3a10163ca9e01b9279227e8d4390e1b307d90`
