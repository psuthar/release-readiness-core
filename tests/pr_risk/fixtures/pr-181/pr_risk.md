...
**Generated:** 2026-04-30T21:19:23Z  
**Base ref:** `9bc9de07f6454a0b7984e802e13e63343db01ebb`  
...
- **Mode:** `focused` — Most churn (~72%) sits under `web/tests`.
- Top area: `web/tests` (~72% of churn); **2** distinct path prefixes.
...
- **`web/tests`** — 10 distinct commits (sampled) — Prefix touched in 10 of the last 50 sampled commits — sustained activity; extra regression care.

### PR intent vs diff

- **Intent strength:** `strong`
- **Subject line (source):** SCRUM-159: refresh tests for participant UX changes
- **Keywords matched:** ci
...
**Score:** 4.0/100 (low) · base `9bc9de07f6454a0b7984e802e13e63343db01ebb`
