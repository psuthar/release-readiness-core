...
**Base ref:** `40dcb45080032830de2b028938cd9e933c95cbf3`  
...
- **Mode:** `focused` — Most churn (~67%) sits under `web/src`.
- Top area: `web/src` (~67% of churn); **2** distinct path prefixes.

### Hotspots (recent git activity)

- **`web/src`** — 22 distinct commits (sampled) — Prefix touched in 22 of the last 50 sampled commits — sustained activity; extra regression care.

### PR intent vs diff

- **Intent strength:** `strong`
- **Subject line (source):** SCRUM-128: improve citation badge labels — prefer human-readable over raw IDs
- **Keywords matched:** ci
...
**Score:** 6.0/100 (low) · base `40dcb45080032830de2b028938cd9e933c95cbf3`
