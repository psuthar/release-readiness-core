...
**Generated:** 2026-04-30T21:19:02Z  
**Base ref:** `725bccf8cc7ed4b2293dc1fa81fff386a9582d96`  
...
- **Mode:** `focused` — Most churn (~100%) sits under `internal/database`.
- Top area: `internal/database` (~100% of churn); **1** distinct path prefixes.

### Hotspots (recent git activity)

- **`internal/database`** — 8 distinct commits (sampled) — Prefix touched in 8 of the last 50 sampled commits — sustained activity; extra regression care.

### PR intent vs diff

- **Intent strength:** `strong`
- **Subject line (source):** SCRUM-228: drop email-match fallback from UserCanAccessSession
...
**Score:** 6.0/100 (low) · base `725bccf8cc7ed4b2293dc1fa81fff386a9582d96`
