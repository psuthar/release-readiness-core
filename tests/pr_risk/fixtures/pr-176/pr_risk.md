...
**Generated:** 2026-04-30T21:19:25Z  
**Base ref:** `51a0c3173a5ce1f1f15b2f7d2cd050c7cb46348a`  

> Medium risk (score 28). Some risk factors are present but are manageable. Review the factors below before merging.
...
| Rationale | Risk band is medium (score 28/100); merge only after completing checklist items and review. |
...
- **`web/src`** — 30 distinct commits (sampled) — Prefix touched in 30 of the last 50 sampled commits — sustained activity; extra regression care.
- **`web/tests`** — 9 distinct commits (sampled) — Prefix touched in 9 of the last 50 sampled commits — sustained activity; extra regression care.

### PR intent vs diff

- **Intent strength:** `unknown`
- **Subject line (source):** SCRUM-154: unified stance dropdown control
...
- **Points:** 12.0
- **Detail:** total LOC churn=606 (threshold 400)

### Large frontend change (`web_large`)

- **Points:** 12.0
- **Detail:** estimated web LOC churn≈606 (threshold 400)

### Diff overlaps a path prefix touched in multiple recent commits (`context_hotspot_overlap`)

- **Points:** 4.0
- **Detail:** Prefix touched in 30 of the last 50 sampled commits — sustained activity; extra regression care.
...
**Score:** 28.0/100 (medium) · base `51a0c3173a5ce1f1f15b2f7d2cd050c7cb46348a`

**PR risk assessment:** **WARN** — Risk band is medium (score 28/100); merge only after completing checklist items and review.
...
**Top risk drivers:**
- Large diff (12 pts): total LOC churn=606 (threshold 400)
- Large frontend change (12 pts): estimated web LOC churn≈606 (threshold 400)
...
**Score math:** factors 28.0 − reducers 0.0 → 28.0 · medium
